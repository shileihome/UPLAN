 ...
 * Description:
 */
public class TopBannerHomeWebActivity_1 extends BaseWebViewActivity {

private String homeUrl;
    public static void start(Context context,String url) {
        Intent starter = new Intent(context, TopBannerHomeWebActivity_1.class);
        ...
        uplanWebView.setWebViewClient(new WebAppClient(this, uplanWebView) {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if(url.equals(WEB_BACK)){
                    webGoBack(TopBannerHomeWebActivity_1.this);
                    return true;
                }
