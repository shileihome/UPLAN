 ...
 * Description:
 */
public class TopBannerHomeWebActivity_2 extends BaseWebViewActivity {

private String homeUrl;
    public static void start(Context context,String url) {
        Intent starter = new Intent(context, TopBannerHomeWebActivity_2.class);
        ...
        uplanWebView.setWebViewClient(new WebAppClient(this, uplanWebView) {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if(url.equals(WEB_BACK)){
                    webGoBack(TopBannerHomeWebActivity_2.this);
                    return true;
                }
